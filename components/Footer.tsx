...
export default function Footer() {
  ...
  const socialLinks = [
    { 
      ...
      href: 'https://www.instagram.com/ashraf.cafe/' 
    },
  ]

  return (
    <footer className="bg-deep-black border-t border-royal-blue-accent/20 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
          ...
          >
            <h3 className="text-2xl font-serif font-bold text-royal-blue-accent mb-4">
              Ashraf Café
            </h3>
            ...
            <div className="flex space-x-4">
              {socialLinks.map((social) => (
                <motion.a
                  ...
                  whileTap={{ scale: 0.9 }}
                  className="text-2xl hover:text-royal-blue-accent transition-colors flex items-center justify-center"
